...
def args_parser():
    ...
    parser.add_argument('--minibatch', type=int, default=100, help="minibatch size: B")
    ...
    parser.add_argument('--iid', action='store_true', help='whether i.i.d or not', default='false')
